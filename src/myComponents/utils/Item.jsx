...
const Item = ({
  ...
  return (
    <>
      <div
        className={`relative text-black hover:text-white  ${color} ${hoverColor} grid items-center justify-items-center rounded-xl  px-2 transition-all duration-700 ease-in-out w-full hover:scale-105`}
      >
        <div className="flex flex-col items-center justify-items-center">
          ...
          <div className="flex item-center gap-1 my-5 ">
            <h1 className="md:text-sm w-14  font-normal">
              <CircularProgressbar
                className="m-auto "
                value={percentage}
                maxValue={1}
